...
//        addUser(insuranceCompany,new User(userID, name, new Address(steetNum, streetName, suburb, city), username, password));
    ...
    public static void createThirdPartyPolicy1(InsuranceCompany insuranceCompany) throws PolicyException // I keep it to show that this also can be done
    {
        Scanner sc = new Scanner(System.in);
...
//        MyDate expiryDate = new MyDate(year, month, day);
    ...
    public static void createComprehensivePolicy1(InsuranceCompany insuranceCompany) throws PolicyException // I keep it to show that this also can be done
    {
        Scanner sc = new Scanner(System.in);
