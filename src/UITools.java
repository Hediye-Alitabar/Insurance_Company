...
public class UITools {
    ...
    public static void addComprehensivePolicy(User user, String policyHolderName, int id, Car car, int numberOfClaims, MyDate expiryDate, int driverAge, int level) throws PolicyException {
    ...
    public static void addThirdPartyPolicy(User user, String policyHolderName, int id, Car car, int numberOfClaims, MyDate expiryDate, String comments) throws PolicyException {
...
//}
    ...
    public static void addThirdPartyPolicy(InsuranceCompany insuranceCompany, int userID, String policyHolderName, int id, Car car, int numberOfClaims, MyDate expiryDate, String comments) throws PolicyException {
    ...
    public static void addComprehensivePolicy(InsuranceCompany insuranceCompany, int userID, String policyHolderName, int id, Car car, int numberOfClaims, MyDate expiryDate, int driverAge, int level) throws PolicyException {
    ...
    public static ThirdPartyPolicy getThirdPartyPolicy() throws PolicyException {
        Scanner sc = new Scanner(System.in);
    ...
    public static ComprehensivePolicy getComprehensivePolicy() throws PolicyException {
        Scanner sc = new Scanner(System.in);
